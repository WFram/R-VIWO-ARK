...
void LocalMapping::FuseSemanticLabels(KeyFrame* pKF, bool* pbStopFlag) {
  ...
  Px[0][1][1] = 0.7f; // P( person, high, was_not_person )
  Px[1][1][1] = 0.3f; // P( not_person, high, was_not_person )

  Px[0][0][0] = 0.3f; // P( person, low, was_person )
  Px[1][0][0] = 0.7f; // P( not_person, low, was_person )
  Px[0][0][1] = 0.2f; // P( person, low, was_not_person )
  Px[1][0][1] = 0.8f; // P( not_person, low, was_not_person )
...
//  cv::waitKey(1);
  cv::imwrite("/home/wfram/Datasets/rgbd_dataset_freiburg3_walking_xyz/Test/"+std::to_string(pKF->mnId)+".png", img);
